...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train BERT for grooming detection.")
    ...
    parser.add_argument("--output-dir", type=Path, default=script_dir / "final_bert_model")
    ...
    print(f"Training BERT on: {'CUDA' if torch.cuda.is_available() else 'CPU'}")
    ...
    print(f"SUCCESS: BERT model saved to {args.output_dir}")
